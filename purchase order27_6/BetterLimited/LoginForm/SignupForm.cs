...
namespace BetterLimited
{
    public partial class SignupForm : Form
    {
        ...
        private bool CheckStrength(string password, out string errorMessage)
        {
            ...
            {
                lblLowercase.BackColor = Color.LightGreen;
            }
            else {
                lblLowercase.BackColor = Color.LightGray;
            }

            if (Regex.IsMatch(password, @"[A-Z]", RegexOptions.ECMAScript))
            {
                lblUppercase.BackColor = Color.LightGreen;
            }
            else
            {
                lblUppercase.BackColor = Color.LightGray;
            }

            if (Regex.IsMatch(password, @"[\d]", RegexOptions.ECMAScript))
            {
                lblNumber.BackColor = Color.LightGreen;
            }
            else
            {
            ...
            {
                lblSymbols.BackColor = Color.LightGreen;
            }
            else
            {
                lblSymbols.BackColor = Color.LightGray;
            }
            if (lblLowercase.BackColor == Color.LightGray || lblUppercase.BackColor == Color.LightGray || lblNumber.BackColor == Color.LightGray || lblSymbols.BackColor == Color.LightGray)
            {
                errorMessage = "Please check your password strength.";
                return false;
            }
            else {
                errorMessage = "";
        ...
        public void sendEmail()
        {
            SmtpClient Client = new SmtpClient()
            {
                ...
                {
                    UserName = "betterlimited123@gmail.com",
                    Password = "ig20czxz"
                }
            };
            MailAddress FromEmail = new MailAddress("betterlimited123@gmail.com", "Better Limited");
        ...
        private void Client_SendCompleted(object sender, AsyncCompletedEventArgs e)
        {
            ...
            DialogResult result = MessageBox.Show("Sign up successfully, please check your email.", "Welcome", MessageBoxButtons.OK);
