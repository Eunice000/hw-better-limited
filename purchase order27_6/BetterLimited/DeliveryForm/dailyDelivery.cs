...
namespace BetterLimited
{
    public partial class dailyDelivery : Form
    {
        ...
        public void DisplayTable()
        {
            ...
            string sql = "SELECT DeliveryID,SalesOrderID,DeliveryDate,DeliveryTime,DeliveryStatus FROM deliveryorder Where DeliveryDate = ' " + dateTimePicker__DeliveryDate.Text + " ';";
