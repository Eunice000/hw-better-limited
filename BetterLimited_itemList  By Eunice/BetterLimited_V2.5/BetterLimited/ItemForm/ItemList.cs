...
namespace BetterLimited
{
    public partial class ItemList : Form
    {
        ...
        private void DisplayTable()
        {
            ...
            adp.Fill(tb1);
            tb1.Columns.Add("ItemImg", Type.GetType("System.Byte[]"));
            foreach (DataRow drow in tb1.Rows)
            {
                //drow["ItemImg"] = File.ReadAllBytes(drow["ImageFile"].ToString());
            }
        ...
        private void dataGridView1_CellClick_1(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 0)
            {
                ...
                item_UpdateForm updateForm = new item_UpdateForm();
            ...
            if (e.ColumnIndex == 1)
            {
                if (MessageBox.Show("You want to delete this item record ?? Debug: Line 113 ", "Infomation", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Information) == DialogResult.Yes)
                {
        ...
        {
            item_New_Form NewForm = new item_New_Form();
            NewForm.Show();
        }
