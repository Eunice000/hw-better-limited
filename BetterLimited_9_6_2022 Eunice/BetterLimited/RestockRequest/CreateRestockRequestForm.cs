...
namespace BetterLimited
{
    public partial class CreateRestockRequestForm : Form
    {
        ...
        {
            string sql = "SELECT ItemID ,ItemCat ,ItemName, ItemDesc ,SalePrice ,SupplierID ,SupplierPrice ,WarrantyMonth, AllowDelivery FROM Item;";
            openConnection();
        ...
        private void button_Search_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "SELECT ItemID ,ItemCat ,ItemName, ItemDesc ,SalePrice ,SupplierID ,SupplierPrice ,WarrantyMonth, AllowDelivery FROM Item;";
            }
            else
            {
                sql = "SELECT ItemID ,ItemCat ,ItemName, ItemDesc ,SalePrice ,SupplierID ,SupplierPrice ,WarrantyMonth, AllowDelivery FROM Item Where ItemID = " + textBox_Search.Text + ";";
            }
            openConnection();
            command = new MySqlCommand(sql, conn);
            MySqlDataAdapter adp = new MySqlDataAdapter(command);
