...
namespace BetterLimited
{
    public partial class UpdateUserAccountForm : Form
    {
        ...
        private void UpdateUserAccountForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Dedug: code in Update_UpdateForm.cs, Error :  Not Data Found");
            }
            closeConnection();
        }
        ...
        private void button_Update_Click(object sender, EventArgs e)
        {
            ...
            string sql = "UPDATE useraccount SET UserName=@UserName,Password=@Password,Email=@Email" +
