...
namespace BetterLimited
{
    public partial class ReOrderRequestForm : Form
    {
        ...
        public ReOrderRequestForm()
        {
            ...
            dgvReOrderRequest.DefaultCellStyle.Font = new Font("Segoe Print", 9);
        }
        ...
        public void showData(string sql)
        {
            try
            {
                ...
                dgvSelectItem.DefaultCellStyle.Font = new Font("Segoe Print", 9);
                checkStock();
                closeConnection();
            }
            catch (Exception ex) 
        ...
        private void checkStock()
        {
            ...
            for (int i = 0; i < dgvSelectItem.Rows.Count; i++)
            {
                ...
                if (quantity < lowLevel)
                {
                    ...
                    dgvSelectItem.Rows[i].Cells[3].Style.Font = new Font("Segoe Print", 12, FontStyle.Bold);
                }
