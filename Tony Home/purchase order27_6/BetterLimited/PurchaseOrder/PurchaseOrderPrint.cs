...
namespace BetterLimited.PurchaseOrder
{
    public partial class PurchaseOrderPrint : Form
    {
        ...
        public void Print()
        {
            ...
            this.DrawToBitmap(bmp, new Rectangle(0, 0, 800, 1000));

            printDocument1.DefaultPageSettings.PaperSize = new PaperSize("Custom", 800, 1100);
            printPreviewDialog1.Size = new Size(900, 1100);
