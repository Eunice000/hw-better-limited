...
namespace BetterLimited.ItemForm
{
    public partial class item_New_Form : Form
    {
        ...
        {
            string sql = "INSERT INTO retailstocklevel VALUES (@ItemID, @ItemName, @storeID, @Quantity, @LowLevelQty)";
        ...
        {
            string sql = "INSERT INTO inventorystocklevel VALUES (@ItemID, @ItemName, @Quantity, @LowLevelQty)";
