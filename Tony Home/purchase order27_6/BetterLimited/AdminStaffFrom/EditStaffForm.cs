...
namespace BetterLimited
{
    public partial class EditStaffForm : Form
    {
        ...
        private void button_Create_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                try
                {
                    ...
                    MessageBox.Show("Update Staff Successfuly.", "Information", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    closeConnection();
                }
                catch (MySqlException ex)
                {
                    MessageBox.Show("Update Staff unuccessfuly. \n " + ex.Message, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                    closeConnection();
                }
        ...
        private void EditStaffForm_Load(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Dedug: code in StaffRecoed_UpdateForm.cs, Error :  Not Data Found");
            }
            closeConnection();
