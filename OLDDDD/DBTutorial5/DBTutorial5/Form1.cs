    ...
    public partial class Form1 : Form
    {
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            using (var classicContext = new classicmodelsEntities())
            {
                ...
                var offCode = (from list in classicContext.offices select list.officeCode);
        ...
        private void comboBox1_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            using (var classicContext = new classicmodelsEntities())
            {
                ...
                var offInfo = from list in classicContext.offices
                              ...
                              select new { list.phone, list.addressLine1, list.addressLine2, list.city, list.country };
                ...
                var staffName = (from list in classicContext.employees where list.officeCode.Contains(temp) select new {list.firstName, list.lastName }); /* Do the following program yourself */
        ...
        private void comboBox2_SelectedValueChanged(object sender, EventArgs e)
        {
            ...
            using (var classicContext = new classicmodelsEntities())
            {
                var staffInfo = from sInfo in classicContext.employees
                                where (sInfo.firstName + " " + sInfo.lastName).Contains(temp)
        ...
        private void textBox1_TextChanged(object sender, EventArgs e)
        {
            using (var classicContext = new classicmodelsEntities())
            {
                ...
                var staffName = from sInfo in classicContext.employees
                                where sInfo.officeCode == comboBox1.SelectedItem && sInfo.firstName.Contains(textBox1.Text)
                                select new { sInfo.firstName, sInfo.lastName };
