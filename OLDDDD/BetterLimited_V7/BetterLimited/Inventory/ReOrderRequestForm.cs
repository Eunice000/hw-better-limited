...
namespace BetterLimited
{
    public partial class ReOrderRequestForm : Form
    {
        ...
        DataTable dt;
        string sql = "SELECT r.ReorderRequestID, ri.ItemID, ri.Qty, r.StaffID, r.RequestDate, r.RequestTime FROM reorderrequest AS r INNER JOIN reorderrequest_item AS ri ON r.ReorderRequestID = ri.ReorderRequestID;";
        string itemID;
        string lowLevelQty;
