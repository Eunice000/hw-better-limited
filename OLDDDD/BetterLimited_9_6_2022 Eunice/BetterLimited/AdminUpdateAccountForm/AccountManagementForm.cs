...
namespace BetterLimited
{
    public partial class AccountManagementForm : Form
    {
        ...
        {
            string sql = "SELECT useraccount.UserAccountID,useraccount.StaffID,useraccount.UserName,useraccount.Password,useraccount.Email,staff.Depart,staff.Position " +
        ...
        private void button_Search_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "SELECT useraccount.UserAccountID,useraccount.StaffID,useraccount.UserName,useraccount.Password,useraccount.Email,staff.Depart,staff.Position " +
                "FROM useraccount,staff " +
                "WHERE useraccount.StaffID = staff.StaffID; ";
            }
            else
