...
namespace BetterLimited
{
    public partial class DeliveryForm : Form
    {
        ...
        private void dataGridView_DeliveryNote_Table_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            if (e.ColumnIndex == 1)
            {
                deliveryID = dataGridView_DeliveryNote_Table.Rows[e.RowIndex].Cells[4].Value.ToString();
            ...
            if (e.ColumnIndex == 2)
            {
                ...
                {
                    DelectDelivery(dataGridView_DeliveryNote_Table.Rows[e.RowIndex].Cells[4].Value.ToString());
                    DisplayTable();
                }
                return;
            }
